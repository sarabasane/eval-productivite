...
describe('La fonction returnAnObject...', () => {
  test('devrait retourner un objet avec des arguments prédéterminés', () => {
    expect(returnAnObject({formation: 'Dev JS', année: '2022', lieu: 'IFOCOP'})
    ).toStrictEqual({
...
describe('La fonction multiplyByTwo...', () => {
  ...
  test('retourne une string si au moins un des arguments n\'est pas un nombre', () => {
    expect(multiplyAllByTwo([1, '2'])).toBe('The argument is not an Array of numbers');
  });
});
